            ...
            <header className="relative z-10 w-full max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
                <div className="flex items-center justify-between gap-4">
                    ...
                    <nav className="hidden md:flex items-center gap-2 text-sm font-medium text-muted-foreground">
                        <a href="#" className="hover:text-foreground px-3 py-2 transition-colors rounded-md">О нас</a>
                        <a href="#" className="hover:text-foreground px-3 py-2 transition-colors rounded-md">Блог</a>
                        <a href="#" className="hover:text-foreground px-3 py-2 transition-colors rounded-md">Контакты</a>
                    </nav>
                    <div className="flex items-center gap-2">
                        ...
                        <button type="button" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="md:hidden p-2.5" aria-label="Open menu">
                ...
                <div className="md:hidden absolute top-0 left-0 w-full h-full bg-background/80 backdrop-blur-sm z-20">
                    <div className="absolute top-24 right-8 p-4 bg-card border shadow-lg rounded-xl w-48">
                        <nav className="flex flex-col gap-2 text-muted-foreground font-medium">
                            <a href="#" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-foreground px-3 py-2 text-sm transition-colors rounded-lg">О нас</a>
                            <a href="#" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-foreground px-3 py-2 text-sm transition-colors rounded-lg">Блог</a>
                            <a href="#" onClick={() => setIsMobileMenuOpen(false)} className="hover:text-foreground px-3 py-2 text-sm transition-colors rounded-lg">Контакты</a>
                        </nav>
                    </div>
                </div>
            )}
